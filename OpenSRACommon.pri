...
INCLUDEPATH +=  $$PATH_TO_RDT \
                $$PATH_TO_RDT/UIWidgets \
                $$PATH_TO_COMMON/Workflow \
                $$PATH_TO_COMMON/Workflow/WORKFLOW \
                $$PATH_TO_COMMON/Workflow/EXECUTION \

SOURCES +=  $$PATH_TO_RDT/CSVReaderWriter.cpp \
            $$PATH_TO_RDT/XMLAdaptor.cpp \
...
HEADERS +=  $$PATH_TO_RDT/XMLAdaptor.h \
            $$PATH_TO_RDT/CSVReaderWriter.h \
