...
EDPGroundStrainWidget::EDPGroundStrainWidget(QWidget* parent) : SimCenterAppWidget(parent)
{
...
QGroupBox* EDPGroundStrainWidget::getWidgetBox(void)
{
    ...
    connect(addRunListButton,&QPushButton::clicked, this, &EDPGroundStrainWidget::handleAddButtonPressed);
...
void EDPGroundStrainWidget::handleAddButtonPressed(void)
{
...
bool EDPGroundStrainWidget::outputToJSON(QJsonObject &jsonObj)
{
...
//    outputObj.insert("ToAssess", toAssessCheckBox->isChecked());
    ...
    jsonObj.insert("TransientGroundStrain",outputObj);

    return true;
}


bool EDPGroundStrainWidget::inputFromJSON(QJsonObject &jsonObject)
{
