...
EDPSurfFaultRupWidget::EDPSurfFaultRupWidget(QWidget* parent) : SimCenterAppWidget(parent)
{
...
QGroupBox* EDPSurfFaultRupWidget::getWidgetBox(void)
{
    ...
    connect(addRunListButton,&QPushButton::clicked, this, &EDPSurfFaultRupWidget::handleAddButtonPressed);
...
void EDPSurfFaultRupWidget::handleAddButtonPressed(void)
{
...
bool EDPSurfFaultRupWidget::outputToJSON(QJsonObject &jsonObj)
{
    ...
    jsonObj.insert("SurfaceFaultRupture",outputObj);

    return true;
}


bool EDPSurfFaultRupWidget::inputFromJSON(QJsonObject &/*jsonObject*/)
{
